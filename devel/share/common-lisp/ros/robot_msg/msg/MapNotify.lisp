...
(cl:defclass <MapNotify> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass MapNotify (<MapNotify>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MapNotify>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MapNotify)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msg-msg:<MapNotify> is deprecated: use robot_msg-msg:MapNotify instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MapNotify>))
...
(cl:defmethod status-val ((m <MapNotify>))
...
(cl:defmethod pose-val ((m <MapNotify>))
...
(cl:defmethod score-val ((m <MapNotify>))
...
(cl:defmethod process-val ((m <MapNotify>))
...
(cl:defmethod expect_time-val ((m <MapNotify>))
...
(cl:defmethod relocated-val ((m <MapNotify>))
...
(cl:defmethod reloc_used_time-val ((m <MapNotify>))
...
(cl:defmethod opt_works_remain-val ((m <MapNotify>))
  ...
  (opt_works_remain m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MapNotify>) ostream)
  "Serializes a message object of type '<MapNotify>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MapNotify>) istream)
  "Deserializes a message object of type '<MapNotify>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MapNotify>)))
  "Returns string type for a message object of type '<MapNotify>"
  "robot_msg/MapNotify")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MapNotify)))
  "Returns string type for a message object of type 'MapNotify"
  "robot_msg/MapNotify")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MapNotify>)))
  "Returns md5sum for a message object of type '<MapNotify>"
  "e6af9f4d8ae8b02d161e4b1c4379ec61")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MapNotify)))
  "Returns md5sum for a message object of type 'MapNotify"
  "e6af9f4d8ae8b02d161e4b1c4379ec61")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MapNotify>)))
  "Returns full string definition for message of type '<MapNotify>"
  (cl:format cl:nil "std_msgs/Header header~%string              status              # 状态~%geometry_msgs/Pose  pose                # 全局位姿~%float32             score               # 得分~%float32             process             # 地图保存进图，100%为已保存状态~%float32             expect_time         # 预测保存地图的时间，假设每秒优化2个~%bool                relocated           # 重定位成功判断~%float32             reloc_used_time     # 上次重定位耗费时间~%int16               opt_works_remain    # 优化队列~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MapNotify)))
  "Returns full string definition for message of type 'MapNotify"
  (cl:format cl:nil "std_msgs/Header header~%string              status              # 状态~%geometry_msgs/Pose  pose                # 全局位姿~%float32             score               # 得分~%float32             process             # 地图保存进图，100%为已保存状态~%float32             expect_time         # 预测保存地图的时间，假设每秒优化2个~%bool                relocated           # 重定位成功判断~%float32             reloc_used_time     # 上次重定位耗费时间~%int16               opt_works_remain    # 优化队列~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MapNotify>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MapNotify>))
